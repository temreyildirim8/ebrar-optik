      ...
      {!isDesktop && (
        <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 shadow-lg shadow-pink-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-500/40 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-pink-500/50"
            aria-label="Instagram'da bizi takip et"
          >
            <svg
              className="h-6 w-6 text-white"
