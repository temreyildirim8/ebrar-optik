...
export function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg shadow-green-500/30 transition-all duration-300 hover:-translate-y-1 hover:bg-green-600 hover:shadow-xl hover:shadow-green-600/30 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-green-500/50"
